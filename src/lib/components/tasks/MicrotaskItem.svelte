<script lang="ts">
  ...
  let { microtask, onToggle, onRemove, onCodar }: Props = $props();
  
  let isDone = $derived(microtask.status === 'done');
</script>
