  ...
  return (
    <div className="flex flex-col h-full relative">
      ...
      <div className={`flex items-center justify-between mb-4 ${isDistributionMode && !isDistributing ? "mt-10" : ""}`}>
        <div className="flex items-center gap-2">
          <button
            ...
            className="p-1 text-[#828282] hover:text-[#d6d6d6] transition-colors"
          >
            <svg
          ...
          <h2 className="text-lg font-medium text-[#d6d6d6] min-w-[180px] text-center">
        ...
        <button
          onClick={goToToday}
          className="px-3 py-1 text-sm bg-[#232323] text-[#d6d6d6] border border-[#3d3a34] hover:bg-[#2a2a2a] transition-colors"
        >
          Hoje
        </button>
      </div>
      ...
      <div className="grid grid-cols-7 mb-1">
        {weekDays.map((day) => (
          <div key={day} className="text-center text-xs text-[#828282] py-1">
            {day}
          </div>
        ))}
      </div>
