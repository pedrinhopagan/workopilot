...
export function CategoryManagementDrawer({
  ...
  const availableForMigration = categories.filter((c) => c.id !== deleteTarget?.id)
  ...
  return (
    <>
      ...
      {deleteTarget && !hasAssociatedTasks.isLoading && (
          ...
          <div className="fixed inset-0 z-[60] flex items-center justify-center">
            ...
            <div className="relative bg-card border border-border p-4 max-w-md w-full mx-4 rounded-md">
              ...
              <div className="flex justify-end gap-2">
                ...
                >
                  {migrateAndDelete.isPending ? "Migrando..." : "Migrar e excluir"}
                </button>
              </div>
            </div>
          </div>
